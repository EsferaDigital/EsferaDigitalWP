...
if(!function_exists('esfera_custom_header')):
  function esfera_custom_header() {
    // Logo
    ...
    add_theme_support('custom-header', apply_filters('esfera_custom_header_args', array(
...
add_action('after_setup_theme', 'esfera_custom_header');
